...
struct Spotify {
  ...
  static let playerStateNotification = Notification.Name("com.spotify.client.PlaybackStateChanged")
...
// MARK: - SpotifyApplication Protocol
...
extension SpotifyTrack {
  ...
  var secureArtworkUrl: URL {
    var url = artworkUrl!
    url.insert("s", at: .init(encodedOffset: 4))
    return URL(string: url)!
  }
  
}

// MARK: - SpotifyTrack Protocol
